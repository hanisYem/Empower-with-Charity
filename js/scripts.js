...
const contactForm = document.getElementById('contactForm'); // Declared once here
if (contactForm) {
...
const donationForm = document.getElementById('donationForm'); // Declared once here
if (donationForm) {
...
showSlides();  // Call showSlides to start the slideshow
